...
<head>
  ...
  <script>
    ...
    function searchCheck(){
    	let seachString = $("#searchString").val();
...
<div class="container">
  ...
  <table class="table table-borderless">
    <tr>
      <td><a href="${ctp}/board/boardInput?pag=${pageVO.pag}&pageSize=${pageVO.pageSize}" class="btn btn-primary btn-sm">글쓰기</a></td>
      <td class="text-right">
        <!-- 한페이지 분량처리 -->
      ...
      <tr>
        ...
        <td>
        	<c:if test="${vo.openSw == 'OK' || sLevel == 0 || sMid==vo.mid}">
	          	<a href="${ctp}/board/boardContent?idx=${vo.idx}&title=${vo.title}&pag=${pageVO.pag}&pageSize=${pageVO.pageSize}">${vo.title}</a>        	
