...
<div class="container">
  ...
  <table class="table table-borderless m-0 p-0">
    <tr>
      <td><a href="${ctp}/board/boardList?pag=${pageVO.pag}&pageSize=${pageSize}" class="btn btn-info btn-sm">돌아가기</a></td>
    </tr>
  </table>
  <table class="table table-hover text-center">
    ...
    <c:forEach var="vo" items="${vos}" varStatus="st">
      <tr>
        <td>${searchCount-st.index}</td>
        <td>
          <a href="${ctp}/board/boardContent?flag=search&search=${search}&searchString=${searchString}&idx=${vo.idx}&pag=${pag}&pageSize=${pageSize}">${vo.title}</a>
