...
<div class="container">
  ...
  <form name="myform" method="post">
    <table class="table table-bordered">
      ...
      <tr>
        <th>글내용</th>
        <td><textarea id="CKEDITOR" rows="6" name="content" class="form-control" required></textarea></td>
       <script>CKEDITOR.replace("content",{
					height : 400,    	 	
        	filebrowserUploadUrl : "${ctp}/imageUpload", /*파일(이미지) 업로드 시 경로*/
        	uploadUrl : "${ctp}/imageUpload"/*여러 파일을 드래그앤드랍해서 올리기*/
        });</script>
      </tr>
      <tr>
        <th>공개여부</th>
